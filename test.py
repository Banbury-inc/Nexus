...
if Config.run_squad_benchmark == True:
    for dataset_question in train_dataset:
        ...
        average_f1_score, total_f1_score = Utils.get_average_f1_score(f1, question_number, total_f1_score)
        colored_average_f1_score = termcolor.colored("Average F1 Score: ", "green")
        print(colored_average_f1_score, average_f1_score)
